  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        aria-label="Star byDefaultHuman on GitHub"
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 rounded-full border border-foreground/20 bg-foreground px-5 py-2.5 text-[13px] font-medium text-background shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl"
      >
